...
function bpmRoute () {
  ...
  bpm.post('/startProcess', function (req, res) {
    ...
    var method = 'POST';
    var path = '/business-central/rest/runtime/' + process.env.BPM_PROCESS_DEPLOYMENTID + '/process/' + process.env.BPM_PROCESS_PROCESSDEFID + '/start?' + createQueryParameterMapString(req.body.params);
  ...
  bpm.post('/testRequest', function(req, res) {
    // Prepare BPM REST call
    var method = 'GET';
    var path = '/business-central/rest';
    var options = getCredentialsForBpmConnection(req,method,path);
    // Execute BPM REST call
    var bpmHttpReq = http.request(options, function (bpmHttpRes) {
      var response = '';
  ...
  bpm.post('/loadTaskContent', function(req, res) {
    // Prepare BPM REST call
    var method = 'GET';
    var path = '/business-central/rest/task/' + req.body.params.taskId + '/content';
    var options = getCredentialsForBpmConnection(req,method,path);
    // Execute BPM REST call
    var bpmHttpReq = http.request(options, function (bpmHttpRes) {
      console.log('STATUS: ' + bpmHttpRes.statusCode)
  ...
  bpm.post('/completeTask', function(req, res) {
    // Prepare BPM REST call
    var method = 'POST';
    var path = '/business-central/rest/task/' + req.body.params.taskId + '/complete?' + createQueryParameterMapString(req.body.params);
    var options = getCredentialsForBpmConnection(req,method,path);
    // Execute BPM REST call
    var bpmHttpReq = http.request(options, function (bpmHttpRes) {
      console.log('STATUS: ' + bpmHttpRes.statusCode)
  ...
  bpm.post('/claimTask', function(req, res) {
    // Prepare BPM REST call
    var method = 'POST';
    var path = '/business-central/rest/task/' + req.body.params.taskId + '/claim';
    var options = getCredentialsForBpmConnection(req,method,path);
    // Execute BPM REST call
    var bpmHttpReq = http.request(options, function (bpmHttpRes) {
      console.log('STATUS: ' + bpmHttpRes.statusCode)
  ...
  bpm.post('/startTask', function(req, res) {
    // Prepare BPM REST call
    var method = 'POST';
    var path = '/business-central/rest/task/' + req.body.params.taskId + '/start';
    var options = getCredentialsForBpmConnection(req,method,path);
    // Execute BPM REST call
    var bpmHttpReq = http.request(options, function (bpmHttpRes) {
      console.log('STATUS: ' + bpmHttpRes.statusCode)
  ...
  bpm.post('/releaseTask', function(req, res) {
    // Prepare BPM REST call
    var method = 'POST';
    var path = '/business-central/rest/task/' + req.body.params.taskId + '/release';
    var options = getCredentialsForBpmConnection(req,method,path);
    // Execute BPM REST call
    var bpmHttpReq = http.request(options, function (bpmHttpRes) {
      console.log('STATUS: ' + bpmHttpRes.statusCode)
...
function createQueryParameterMapString (jsonInput) {
  ...
  function getCredentialsForBpmConnection (req, method, path){
    ...
    if(isBlank(process.env.BPM_USERNAME)){
      username = req.body.params.username;
    }else{
      username = process.env.BPM_USERNAME;
    }

    if(isBlank(process.env.BPM_PASSWORD)){
      password = req.body.params.password;
    }else{
      password = process.env.BPM_PASSWORD;
    }

    if(isBlank(process.env.BPM_IP)){
      ip = req.body.params.ip;
    }else{
      ip = process.env.BPM_IP;
    }

    if(isBlank(process.env.BPM_PORT)){
